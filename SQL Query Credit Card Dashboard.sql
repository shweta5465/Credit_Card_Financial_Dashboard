...
COPY cc_detail
FROM 'C:\Program Files\PostgreSQL\18\data/credit_card (1).csv'
DELIMITER ','
CSV HEADER;
...
COPY cust_detail
FROM 'C:\Program Files\PostgreSQL\18\data/customer (1).csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cc_detail
FROM 'C:\Program Files\PostgreSQL\18\data/cc_add (1).csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'C:\Program Files\PostgreSQL\18\data/cust_add (1).csv' 
DELIMITER ',' 
CSV HEADER;
